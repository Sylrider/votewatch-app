...
>
Last updated: 2026-06-10 - by: chrome ext STEP 6 + FEC enrichment root-cause fix (MAX_PAGES/FUNDING_CYCLE scope); STEP 8 added (true names + funder character, FEC-only).
---
...
8. [ ] STEP 8 - FEC enrichment quality (true names + funder character; FEC-only, no OpenSecrets per user 2026-06-10):
