...
>
> "Last updated: 2026-06-10 - by: chrome ext UI: politician card footer (lobby/stock/legal stats + Profile badge) now pinned to BOTTOM of each equal-height tile via marginTop:auto, so there is no empty gap below it. Commit 19b7bff, green, verified live (footer flush to card bottom on all 24 tiles, only 1px border below)."
---
