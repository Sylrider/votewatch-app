...
>
Last updated: 2026-06-10 - by: chrome ext STEP 8 data layer DONE (true committee names + committeeType/orgType/party + donor occupation in fec.ts, commit 9e09cab); verified live on Vindman profile (run #82, count=5). UI render of new descriptor fields still pending.
---
...
8. [~] STEP 8 - FEC enrichment quality (true names + funder character; FEC-only, no OpenSecrets per user 2026-06-10): DATA LAYER DONE 9e09cab, UI render pending.
